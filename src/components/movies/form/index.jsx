...
export default class MovieForm extends Component {
    ...
    componentDidMount = async () => {
        if (this.props.match.params.movieId) {
            //Update Movie
            try {
                //Nos traemos y deconstruimos movieId
                const { movieId } = this.props.match.params
                //Creo una variable data 
                const data = await getMovie(movieId)
                //Valido que los datos no tengan error
                if (!data.hasError) {
                    //Utilizamos el metodo para desformatear para solo quedarme con la hora y los minutos
                    data.schedules = this.unFormatSchedules(data.schedules)
                    //Seteamos la informacion de la data
                    this.setState({
                        isCreate: false,
                        isReady: true,
                        newMovie: data,
    ...
    // Desformateamos los horarios para compatibilidad con Backend
